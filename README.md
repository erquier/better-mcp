...
- **Node.js 20.19+ / 22.12+** para desarrollo (lo exige la toolchain: Vite 8 / Vitest 4). El paquete publicado (`dist/`) sigue soportando Node 18+ en runtime — este requisito más alto aplica solo a quien contribuye al repo.
